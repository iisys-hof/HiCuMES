...
public class RunSyncDelegate extends DelegateSuperClass implements JavaDelegate {
    ...
    public void execute(DelegateExecution execution) throws Exception
    {
        ...
        {
            System.out.println("--------------------------------------------------");
            System.out.println("+++++++++++++++ RunSyncDelegate ++++++++++++++++++");
            System.out.println("--------------------------------------------------");
            ObjectNode event = super.buildHazelcastRunMappingEvent(execution);

            JsonNode newEvent = new EventGenerator().generateEvent(Events.MappingReceiveTopic.RUN_SYNC, event);
