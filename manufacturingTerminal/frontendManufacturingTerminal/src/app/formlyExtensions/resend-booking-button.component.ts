...
@Component({
  selector: 'formly-resend-booking-button',
  template: `
...
export class ResendBookingButton extends FieldWrapper {
  // @ts-ignore
  ...
  onClick($event: Event) {
    ...
    this.serverRequestService.resendBookingEntry(get(this.model, this.key))
  }
