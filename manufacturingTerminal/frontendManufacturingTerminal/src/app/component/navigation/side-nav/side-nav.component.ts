...
export class SideNavComponent implements OnInit {
  ...
  constructor(private readonly keycloak: KeycloakService, private sideNavService: SideNavService, private navigationService: NavigationService, private selectionStateService: SelectionStateService, private router: Router) {
